...
export type Mutation = {
  ...
  splitTeam: MutationSplitTeamResult;
...
export type MutationSplitTeamArgs = {
  eventId: Scalars['ID']['input'];
  roundNo: Scalars['ID']['input'];
};
...
export type MutationSplitTeamResult = Error | MutationSplitTeamSuccess;

export type MutationSplitTeamSuccess = {
  __typename?: 'MutationSplitTeamSuccess';
  data: Array<Team>;
};
...
export type SplitTeamMutationVariables = Exact<{
  eventId: Scalars['ID']['input'];
  roundNo: Scalars['ID']['input'];
}>;


export type SplitTeamMutation = { __typename?: 'Mutation', splitTeam: { __typename: 'Error', message: string } | { __typename: 'MutationSplitTeamSuccess', data: Array<{ __typename?: 'Team', name: string, roundNo: number, leaderId?: number | null }> } };
...
export type GetSponsorsQuery = { __typename?: 'Query', getSponsors: { __typename: 'Error', message: string } | { __typename: 'QueryGetSponsorsSuccess', data: Array<{ __typename?: 'Sponsor', description: string, id: string, imageUrl: string, name: string, title: string, websiteUrl: string }> } };
...
export const SplitTeamDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SplitTeam"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"eventId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"roundNo"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"splitTeam"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"eventId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"eventId"}}},{"kind":"Argument","name":{"kind":"Name","value":"roundNo"},"value":{"kind":"Variable","name":{"kind":"Name","value":"roundNo"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Error"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"MutationSplitTeamSuccess"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"Field","name":{"kind":"Name","value":"data"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"roundNo"}},{"kind":"Field","name":{"kind":"Name","value":"leaderId"}}]}}]}}]}}]}}]} as unknown as DocumentNode<SplitTeamMutation, SplitTeamMutationVariables>;
